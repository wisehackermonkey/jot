...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR args, int ncmdshow) {
    ...
    wc.hbrBackground = (HBRUSH)CreateSolidBrush(RGB(0x44, 0x46, 0x54));
    ...
    CreateWindowW(L"TextEditor", L"Simple Text Editor", WS_OVERLAPPEDWINDOW | WS_VISIBLE, 100, 100, 500, 600, NULL, NULL, NULL, NULL);
